...
1. **Understand Butler**: Read the [README](https://github.com/butlerdotdev/butler/blob/main/README.md) and [Architecture docs](https://github.com/butlerdotdev/butler/tree/main/docs/architecture/)
2. **Find something to work on**: Browse issues labeled `good first issue` or `help wanted`
3. **Set up your environment**: Follow the [Development Setup](https://github.com/butlerdotdev/butler/blob/main/docs/contributing/development-setup.md) guide
...
**Repository**: [butler](https://github.com/butlerdotdev/butler)
...
**Action**: Open an issue in the [umbrella repo](https://github.com/butlerdotdev/butler/issues) first
...
See the [Development Setup Guide](https://github.com/butlerdotdev/butler/blob/main/docs/contributing/development-setup.md) for detailed instructions.
...
All commits must be signed off to indicate agreement with the [Developer Certificate of Origin](https://github.com/butlerdotdev/butler/blob/main/DCO.md):
...
1. **Open a tracking issue** in the [umbrella repo](https://github.com/butlerdotdev/butler/issues)
...
1. **Copy the template**: [`design/proposals/NNNN-template.md`](https://github.com/butlerdotdev/butler/blob/main/design/proposals/NNNN-template.md)
...
See the [Design Proposals README](https://github.com/butlerdotdev/butler/blob/main/design/proposals/README.md) for the full process.

### ADRs (Architectural Decision Records)

For architectural decisions, use the ADR format in [`design/adr/`](https://github.com/butlerdotdev/butler/tree/main/design/adr/). ADRs document the context, decision, and consequences of significant technical choices.
...
Community meetings are held bi-weekly. See [community/meetings/](https://github.com/butlerdotdev/butler/tree/main/community/meetings/) for schedule and notes.
